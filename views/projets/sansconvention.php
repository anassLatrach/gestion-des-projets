<?php 
    ...
    $convention=$projetAff->afficherConvention();
?>
								    ...
								    <div class="m-portlet__body">
                                        ...
                                        <div class="form-group m-form__group row">
							                 <div class="col-lg-12">
													...
													<div class="m-input-icon m-input-icon--right">
													<select  name="convention" class="form-control m-input">
                                                                    <option value="null">
                                                                    Pas De convention 
                                                                    </option>
                                                                    <?php foreach($convention as $itemConvention) : ?>
                                                                        
                                                                        <option value=<?php echo $itemConvention['id_convention']?>>
																		<?php echo $itemConvention['secteur_activite'] ?>
                                                                        </option>
																	<?php endforeach;?>
